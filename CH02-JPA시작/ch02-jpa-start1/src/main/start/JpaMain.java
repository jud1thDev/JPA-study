...
public class JpaMain {
    ...
    public static void main(String[] args) {
        ...
        // 1. 엔티티 매니저 설정
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("jpabook"); // 엔티티 매니저 팩토리 생성(비용이 많이 든다)
        EntityManager em = emf.createEntityManager(); // 엔티티 매니저 생성(비용이 별로 안 든다)
    ...
    public static void logic(EntityManager em) {
        ...
        // 메서드 호출 시 1차 캐시에서 식별자 값으로 엔티티를 찾는다. 1차 캐시에 없다면, 데이터베이스를 조회해서 엔티티를 생성한 후 1차 캐시에 저장한다.
